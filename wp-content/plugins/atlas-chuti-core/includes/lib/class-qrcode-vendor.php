...
//---------------------------------------------------------------
// QRCode for PHP5 — vendored, unmodified apart from this header block.
//
...
//
// Vendored into Atlas chutí (KROK 2 print recept, item 8 of the brief) as a
// small, dependency-free, fully local QR encoder — no external web service is
// ever called to produce a QR image. Round-trip verified (encode here, decode
// with an independent zbar-based reader) before being wired into the print
// layout — see class-qrcode.php for the thin wrapper actually used by the
// theme, and docs/implementation-reports/step-02-recipe-detail.md for the
// verification method.
//---------------------------------------------------------------------
